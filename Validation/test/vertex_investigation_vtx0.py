...
process.flashggDiPhotons = flashggDiPhotons.clone(
        useZerothVertexFromMicro = cms.bool(True)
        )
from flashgg.MicroAOD.MicroAODCustomize import MicroAODCustomize
micro_aod_customize = MicroAODCustomize()
micro_aod_customize.metaConditions = customize.metaConditions
micro_aod_customize.customizeDiPhotons(process)
