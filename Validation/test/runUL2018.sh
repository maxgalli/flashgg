...
#fggRunJobs.py --load jobs_UL18_MC.json -x cmsRun tagAndProbe_test.py -d ${outDir}_mc_UL18 maxEvents=1000 useAAA=1 doPhoIdInputsCorrections=1 --make-light-tarball --stage-to=/eos/cms/store/group/phys_higgs/cmshgg/gallim/TnPProduction/${outDir}_mc_UL18/ -n 1 --no-copy-proxy -H &
...
#fggRunJobs.py --load jobs_UL18_data.json -x cmsRun tagAndProbe_test.py -d ${outDir}_data_UL18 maxEvents=1000 useAAA=1 doPhoIdInputsCorrections=1 --make-light-tarball --stage-to=/eos/cms/store/group/phys_higgs/cmshgg/gallim/TnPProduction/${outDir}_data_UL18 -n 1 --no-copy-proxy -H &
